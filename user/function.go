...
func internMonitoring_User(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == http.MethodHead {
		fmt.Fprintf(w, module.GCFHandlerGetUserFromIDByAdmin("PASETOPUBLICKEY", "MONGOSTRING", "db_intermoni", r))
		return
	}
	// Set CORS headers for the main request.
	fmt.Fprintf(w, module.GCFHandlerGetUserFromID("PASETOPUBLICKEY", "MONGOSTRING", "db_intermoni", r))
}
