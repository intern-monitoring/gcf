...
func internMonitoring_Magang(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == http.MethodPost {
		fmt.Fprintf(w, magang.Post("PASETOPUBLICKEY", "MONGOSTRING", "db_intermoni", r))
		return
	}
	if r.Method == http.MethodPut {
		fmt.Fprintf(w, magang.Put("PASETOPUBLICKEY", "MONGOSTRING", "db_intermoni", r))
		return
	}
	// Set CORS headers for the main request.
	fmt.Fprintf(w, magang.Get("PASETOPUBLICKEY", "MONGOSTRING", "db_intermoni", r))
}
